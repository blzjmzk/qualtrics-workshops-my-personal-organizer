      ...
      <Form className="add-task-form">
        ...
        <Form.Group className="mb-3">
          <Form.Select
            ...
            aria-label="Dropdown menu with task status to select"
          >
        ...
        <Form.Group className="mb-3">
          <Form.Select
            ...
            aria-label="Dropdown menu with task priorities to select"
          >
        ...
        <Form.Group className="mb-3">
          <Form.Select
            ...
            value={size}
            onChange={(e) => {
              setSize(e?.target.value as TaskSize);
            }}
            aria-label="Dropdown menu with task size to select"
          >
            <option>Set task size</option>
            {Object.values(TaskSize).map((taskSize) => (
              <option key={taskSize} value={taskSize}>
                {taskSize}
              </option>
            ))}
          </Form.Select>
        ...
        <Form.Group className="mb-5">
          <Form.Control
            value={details}
            placeholder="Put task details here"
            onChange={(e) => {
